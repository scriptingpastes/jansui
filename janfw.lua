...
function library:Create(class, properties)
	...
	for property, value in next, properties do
		if not a and property == "Parent" then
			continue
		end
		inst[property] = value
	end
...
library.SettingsMenu:AddBind({text = "Open / Close", flag = "UI Toggle", nomouse = true, key = "Delete", callback = function(bool) library:Close() end})
library.SettingsMenu:AddColor({text = "Menu Color", flag = "Menu Accent Color", color = Color3.fromRGB(255, 255, 255), callback = function(Color)
...
library.SettingsMenu:AddList({text = "Background", max = 4, values = {"Floral", "Flowers", "Circles", "Hearts"}, value = "Floral", callback = function(v)
	if library.main then
		library.main.Image = backgroundlist[v];
	end
end}):AddColor({color = Color3.new(), callback = function(color)
	if library.main then
...
library.SettingsMenu:AddSlider({text = "Tile Size", min = 50, max = 500, value = 90, callback = function(v)
	if library.main then
		library.main.TileSize = UDim2.new(0, v, 0, v);
	end
end});
